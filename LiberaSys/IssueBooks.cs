    ...
    public partial class IssueBooks : UserControl
    {
                ...
                if(connect.State != ConnectionState.Open)
                {
                    try
                    {
                        ...
                        using(SqlCommand cmd = new SqlCommand(insertData, connect))
                        {
                            ...
                            MessageBox.Show("Издадена успешно!", "Информация", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void bookIssue_updateBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (connect.State != ConnectionState.Open)
                {
                    DialogResult check = MessageBox.Show("Сигурни ли сте, че искате да ПРОМЕНИТЕ Issue ID:"
                        + bookIssue_id + "?", "Потвърждение", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void bookIssue_deleteBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (connect.State != ConnectionState.Open)
                {
                    DialogResult check = MessageBox.Show("Сигурни ли сте, че искате да ИЗТРИЕТЕ Issue ID:"
                        + bookIssue_id.Text.Trim() + "?", "Потвърждение", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                    ...
                    if (check == DialogResult.Yes)
                    {
                        try
                        {
                            ...
                            using (SqlCommand cmd = new SqlCommand(updateData, connect))
                            {
                                ...
                                MessageBox.Show("Изтрито успешно!", "Информация", MessageBoxButtons.OK, MessageBoxIcon.Information);
