    ...
    public partial class ReturnBooks : UserControl
    {
        ...
        private void returnBooks_returnBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    DialogResult check = MessageBox.Show("Сигурни ли сте, че Issue ID: "
                        + returnBooks_issueID.Text.Trim()
                        + "е върнатa вече?", "Потвърждение", MessageBoxButtons.YesNo
                    ...
                    if(check == DialogResult.Yes)
                    {
                        try
                        {
                            ...
                            using (SqlCommand cmd = new SqlCommand(updateData, connect))
                            {
                                ...
                                MessageBox.Show("Върната успешно!", "Информация", MessageBoxButtons.OK, MessageBoxIcon.Information);
